...
namespace
{
  ...
  struct Scanner
  {
    ...
    bool scan(TSLexer *lexer, const bool *valid_symbols)
    {
      ...
      if (valid_symbols[RAW_TEXT] && !valid_symbols[START_TAG_NAME] && !valid_symbols[END_TAG_NAME] && !valid_symbols[JSP])
      {
